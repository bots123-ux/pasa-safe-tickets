    ...
    <div className="px-5 py-6">
      ...
      {loading ? (
        ...
        <>
                ...
                {(["en", "fil"] as const).map((l) => (
                  <button
                    ...
                    className={cn(
                      ...
                      lang === l ? "border-accent bg-accent/10 text-primary" : "border-border",
                    )}
                  >
          ...
          <Button variant="outline" size="lg" className="w-full text-destructive hover:bg-destructive/5" onClick={handleLogout}>
